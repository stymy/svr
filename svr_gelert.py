...
def train(testset, dataset, filename, ROI_data, ROIs, reverse=False):
    if reverse==True:
        data = testset
        input_data = glob.glob('/home2/data/Projects/CCB/'+testset+'/*REST2.nii.gz')[0]
        total_mask = glob.glob('/home2/data/Projects/CCB/'+testset+'/*automask.nii')[0]
    else:
        data = dataset
        input_data = glob.glob('/home2/data/Projects/CCB/'+dataset+'/*REST1.nii.gz')[0]
        total_mask = glob.glob('/home2/data/Projects/CCB/'+dataset+'/*automask.nii')[0]
    #loop through each ROI
    for ROI_num in np.unique(ROI_data):
        #set outputs
        timeseries = '/home2/data/Projects/CCB/'+data+'/timeseries'+str(ROI_num)+'.1D'
        mask = '/home2/data/Projects/CCB/'+data+'/mask'+str(ROI_num)+'.nii'
        model = '/home2/data/Projects/CCB/'+data+'/model_run'+str(ROI_num)+'.nii'
        w = '/home2/data/Projects/CCB/'+data+'/w_run'+str(ROI_num)+'.nii'
        alphas = '/home2/data/Projects/CCB/'+data+'/alphas_run'+str(ROI_num)
...
def test(dataset, testset, filename, ROI_data, reverse=False):
    if reverse == True:
        ...
        data2 = testset
    for ROI_num in np.unique(ROI_data):
        model = '/home2/data/Projects/CCB/'+data1+'/model_run'+str(ROI_num)+'.nii'
        if not os.path.isdir('/home2/data/Projects/CCB/svr_prediction/'):
            os.mkdir('/home2/data/Projects/CCB/svr_prediction/')
        prediction = '/home2/data/Projects/CCB/svr_prediction/predict_'+data2+'_with_'+data1+'_run'+str(ROI_num)
        real_model = '/home2/data/Projects/CCB/'+data2+'/timeseries'+str(ROI_num)+'.1D'
        testing = afni.SVMTest()
        testing.inputs.in_file= glob.glob('/home2/data/Projects/CCB/'+data2+'/*.nii.gz')[0]
...
def stats(testset, dataset, ROI_data):
    ...
    for ROI_num in np.unique(ROI_data):
        ...
        ##Accuracy 1<-2
        pred_file = '/home2/data/Projects/CCB/svr_prediction/predict_'+testset+'_with_'+dataset+'_run'+str(ROI_num)+'.1D'
        TS_file = '/home2/data/Projects/CCB/'+testset+'/timeseries'+str(ROI_num)+'.1D'
        acc1w2.append(accuracy(pred_file, TS_file))
        ##Accuracy 1->2
        pred_file = '/home2/data/Projects/CCB/svr_prediction/predict_'+dataset+'_with_'+testset+'_run'+str(ROI_num)+'.1D'
        TS_file = '/home2/data/Projects/CCB/'+dataset+'/timeseries'+str(ROI_num)+'.1D'
        acc2w1.append(accuracy(pred_file, TS_file))
        ##Reproducibility
        w1 = nb.load('/home2/data/Projects/CCB/'+dataset+'/w_run'+str(ROI_num)+'.nii').get_data()
        w2 = nb.load('/home2/data/Projects/CCB/'+testset+'/w_run'+str(ROI_num)+'.nii').get_data()
        rep.append(reproducibility(w1,w2))
    if not os.path.isdir('/home2/data/Projects/CCB/svr_stats'):
        os.mkdir('/home2/data/Projects/CCB/svr_stats')
        
    paths = ['/home2/data/Projects/CCB/svr_stats/acc_'+testset+'_with_'+dataset+'.npy',
             '/home2/data/Projects/CCB/svr_stats/acc_'+dataset+'_with_'+testset+'.npy',
             '/home2/data/Projects/CCB/svr_stats/rep_'+dataset+'+2.npy']
...
if __name__ == "__main__":
    datadir = '/home2/data/Projects/CCB/'
